...
# :4949 munin
# :783 spamd
lsof -Pni |grep -vE ':80|:443|:783|:4949|imap|pop3|named|cpdavd|courier|dovecot|exim|mysql|pure|pro|sshd|cpsrvd|spamd|ntpd|postgre'; echo
...
if [ "$fatal_hd_error" ];
 then echo -e $red"This error indicates a failing drive in dmesg:"$clroff"\n"$fatal_hd_error"\n"
fi
