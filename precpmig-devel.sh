...
setup_remote(){
    ...
    if [[ $precpmig = "1" ]]; then
        ...
        local_site_check_location=https://raw.githubusercontent.com/cPMarco/cpm/master/local_site_check.sh
